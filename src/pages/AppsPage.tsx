...
import { ExternalLink, Loader2, AlertCircle, LayoutGrid, PlusCircle } from 'lucide-react';
          ...
          {apps.map((app, i) => (
            ...
            >
              <Link
                ...
                className="block glass-card p-5 hover:border-primary/30 transition-colors group"
              >
